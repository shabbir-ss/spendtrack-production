...
export default function EditExpenseModal({ id, initial, children }: Props) {
  ...
  const form = useForm<InsertExpense & { accountId?: string | null; invoiceNumber?: string | null; invoiceDate?: string | null; invoiceAmount?: string | null }>({
  ...
  const mutate = useMutation({
    mutationFn: (data: InsertExpense & { accountId?: string | null; invoiceNumber?: string | null; invoiceDate?: string | null; invoiceAmount?: string | null }) => api.put(`/expenses/${id}`, data),
    onSuccess: () => {
  ...
  const onSubmit = (data: InsertExpense & { accountId?: string | null; invoiceNumber?: string | null; invoiceDate?: string | null; invoiceAmount?: string | null }) => mutate.mutate(data);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex space-x-3 pt-4">
              ...
              <Button type="submit" className="flex-1 bg-expense hover:bg-expense/90" disabled={mutate.isPending}>
